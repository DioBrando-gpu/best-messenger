# DIO Messenger - полноценный Мессенджер

**Современный мессенджер с поддержкой постов, чата и будущей функциональностью шифрования.**
...
- Мобильное приложение apk и desktop-приложение

## 🛠️ Технологический стек

- **Backend:** Node.js + Express
- **Frontend:** Vanilla JavaScript + CSS3
- **Хранилище:** PostgreSQL Database
...
Проект пока в разработке, предлагайте улучшения! Вносите улучшения через pull requests.
